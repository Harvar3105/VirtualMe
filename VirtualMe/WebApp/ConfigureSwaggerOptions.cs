...
public class ConfigureSwaggerOptions : IConfigureOptions<SwaggerGenOptions>
{
    ...
    public void Configure(SwaggerGenOptions options)
    {
        ...
        options.SchemaFilter<ExcludeTypesSchemaFilter>();
    }
}

public class ExcludeTypesSchemaFilter : ISchemaFilter
{
    public void Apply(OpenApiSchema schema, SchemaFilterContext context)
    {
        if (context.Type.Name.Contains("BLL") || context.Type.Name.Contains("DAL") || context.Type.Name.Contains("Domain"))
        {
