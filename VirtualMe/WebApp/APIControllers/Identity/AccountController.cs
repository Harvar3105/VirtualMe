...
namespace WebApp.APIControllers.Identity;
    ...
    /// <summary>
    /// Used for API user connection controls.
    /// </summary>
    [ApiVersion("1.0")]
    [ApiController]
    ...
    public class AccountController : ControllerBase
{
    ...
    /// <summary>
    /// Constructor for controller. Uses DI.
    /// </summary>
    /// <param name="userManager">Used to get user entity by its credentials.</param>
    /// <param name="logger">Create messages and warnings. Valid only at runtime.</param>
    /// <param name="signInManager">Check user privacy data and create credentials.</param>
    /// <param name="configuration">Used for access app config, like appsettings.json</param>
    /// <param name="context">Context for getting data from data base.</param>
    ...
    /// <summary>
    /// Register new local user into application.
    /// </summary>
    /// <param name="registrationData">Username, password and personal details.</param>
    /// <param name="expiresInSeconds">Override jwt lifetime.</param>
        ...
        int expiresInSeconds)
    {
        ...
        result = await _userManager.AddClaimsAsync(appUser, new List<Claim>()
        {
            ...
            new (ClaimTypes.Name, appUser.NickName)
        });
    ...
    /// Login user into app.
    /// </summary>
    /// <param name="loginInfo"> Users email and password.</param>
    /// <param name="expiresInSeconds"> For how long JWT token will be valid.</param>
    ...
    )
    {
        ...
        else
        {
            ...
            _logger.LogInformation("Deleted {} refresh tokens", tokensToRemove.Count);
        }
    ...
    /// Refresh JWT Token.
    /// </summary>
    /// <param name="tokenRefreshInfo"> The token itself.</param>
    /// <param name="expiresInSeconds"> For how long the token will be valid.</param>
    ...
    {
        if (expiresInSeconds <= 0) expiresInSeconds = 120;
        expiresInSeconds = expiresInSeconds < _configuration.GetValue<int>("JWT:expiresInSeconds")
            ? expiresInSeconds
            : _configuration.GetValue<int>("JWT:expiresInSeconds");
    ...
    /// </summary>
    /// <param name="logout">Users JWT Token. Currently not used.</param>
    /// <returns>Amount of deleted tokens.</returns>
